...
class SimulationSetupTwoStreamHermite:
    def __init__(self, Nx,  Nv_e1, Nv_e2, epsilon, alpha_e1, alpha_e2, alpha_i, u_e1, u_e2, u_i, L,
        ...
        self.A_diag_e1 = A2(D=self.D, Nv=self.Nv_e1)
        self.A_off_e1 = A1_hermite(D=self.D, Nv=self.Nv_e1)
        self.A_col_e1 = A3(Nx=self.Nx, Nv=self.Nv_e1)

        self.A_diag_e2 = A2(D=self.D, Nv=self.Nv_e2)
        self.A_off_e2 = A1_hermite(D=self.D, Nv=self.Nv_e2)
        self.A_col_e2 = A3(Nx=self.Nx, Nv=self.Nv_e2)

        self.A_diag_i = A2(D=self.D, Nv=self.Nv_i)
        self.A_off_i = A1_hermite(D=self.D, Nv=self.Nv_i)
        self.A_col_i = A3(Nx=self.Nx, Nv=self.Nv_i)

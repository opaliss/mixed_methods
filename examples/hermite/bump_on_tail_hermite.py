...
def rhs(y):
    ...
    dydt_[:setup.Nv_e1 * setup.Nx] = setup.A_e1 @ y[:setup.Nv_e1 * setup.Nx] \
                                     + nonlinear_hermite(E=E, psi=y[:setup.Nv_e1 * setup.Nx], Nv=setup.Nv_e1, Nx=setup.Nx,
    ...
    dydt_[setup.Nv_e1 * setup.Nx:] = setup.A_e2 @ y[setup.Nv_e1 * setup.Nx:] \
                                     + nonlinear_hermite(E=E, psi=y[setup.Nv_e1 * setup.Nx:], Nv=setup.Nv_e2, Nx=setup.Nx,
